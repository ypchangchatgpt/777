#streamlit run /Users/lizongsiou/Desktop/數值分析/untitled1.py
...
if submit_button:
    bar = st.progress(0,'史努比：哭啊遇到一個爛主人')#顯示進度條
...
# 重复上述步骤，对第二和第三个子图进行相同的操作，并设置透明度
    fig.add_trace(go.Histogram(
        x=STs_quasi, 
        name='quasi', 
        marker_color='red', 
    ...
    # 更新布局设置
    fig.update_layout(
        title='不同方法計算的到期時股票價格分布',
        xaxis_title='到期時股票價格',
        yaxis_title='',
        height=900  # 设置图表的高度，以便于展示所有子图
        )
